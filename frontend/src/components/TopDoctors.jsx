...
const TopDoctors = () => {
  ...
  return (
    <div className='flex flex-col items-center gap-4 my-16 md:mx-10'>
      <h1 className='text-3xl font-medium text-textPrimary'>Top Doctors to Book</h1>
      ...
      <div className='w-full grid grid-cols-[repeat(auto-fill,minmax(200px,1fr))] gap-4 pt-5 gap-y-6 px-3 sm:px-0'>
        {doctors.slice(0, 10).map((item) => (
          ...
          >
            <div className='h-48'>
              <img src={item.image} alt="Doctor's profile picture" className='w-full h-full object-cover' />
            </div>
            <div className='p-4'>
      ...
      <button
        ...
        className='bg-primary text-white px-12 py-3 rounded-full mt-10 hover:bg-primary/90 transition'
      >
        more
      </button>
    </div>
